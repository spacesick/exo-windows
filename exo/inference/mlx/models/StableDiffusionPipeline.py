...
class Model(nn.Module):
  ...
  def __call__(
    ...
    return x, {
      'conditioning': conditioning, 'mask': mask, 'residual': residual, 'x_t_prev': x_t_prev, 'is_finished': is_finished, 'is_step_finished': is_step_finished, 'step': step,
      'total_steps': total_steps, 'start_step': start_step, 'image': image
    }
