...
class GRPCPeerHandle(PeerHandle):
  ...
  def serialize_generation_options(self, generation_options: GenerationOptions) -> node_service_pb2.GenerationOptions:
    return node_service_pb2.GenerationOptions(max_completion_tokens=generation_options.max_completion_tokens, stop=generation_options.stop, grammar_definition=generation_options.grammar_definition)
